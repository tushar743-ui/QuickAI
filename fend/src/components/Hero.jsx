    ...
    <div className=' px-4 sm:px-20 xl:px-32
      ...
      bg-cover bg-no-repeat'>
        ...
        <div className='text-center mb-6'> 
            <h1 className='text-3xl sm:text-5xl md:text-6xl 3xl:text-7xl font-semibold mx-auto leading-[1.2]'>
        ...
        <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
          <button onClick={()=>navigate('/ai')} className='bg-purple-600 px-10 py-3 rounded-lg  hover:scale-102 active:scale-95 transition cursor-pointer text-white'>Start Creating Now</button>
        ...
        <div className='flex items-center gap-4 mt-8 mx-auto text-gray-600'>
          <img loading="lazy" src={assets.user_group} alt="" className='h-8' />Trusted by 10k+ people
        </div>
