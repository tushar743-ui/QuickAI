...
const GenerateImages = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      setLoading(true);
      const prompt = `Generate an image of ${input} in ${selectedStyle} style. The image should be visually appealing, creative, and relevant to the description provided. Please ensure that the generated image is unique and does not infringe on any copyrights.`;
    ...
    <div className="h-full overflow-y-auto p-6 flex items-start flex-wrap gap-4 text-slate-700">
      ...
      >
        ...
        <textarea
          ...
          placeholder="Describe what you want you see in the image ..."
          required
        />
        ...
        <div className="flex-1 flex justify-center items-center">
          <div className="text-sm flex flex-col items-center gap-5 text-gray-400">
            ...
            <div className="mt-3 h-full">
              <img loading="lazy" src={content} alt="image" className="w-full h-full"/>
            </div>
          )
        }
